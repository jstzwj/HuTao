...
//'<A Unicode Character Of Classes Lu, Ll, Lt, Lm, Lo, Or Nl>' WARNING: ignores
// UnicodeEscapeSequence
...
//'<A Unicode Character Of The Class Pc>' WARNING: ignores UnicodeEscapeSequence
fragment ConnectingCharacter:
	UnicodeClassPC
	| UnicodeEscapeSequence;

//'<A Unicode Character Of Classes Mn Or Mc>' WARNING: ignores UnicodeEscapeSequence
fragment CombiningCharacter:
	UnicodeClassMN
	| UnicodeClassMC
	| UnicodeEscapeSequence;

//'<A Unicode Character Of The Class Cf>' WARNING: ignores UnicodeEscapeSequence
